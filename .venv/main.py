...
from facemesh import facemeshapp, face_swap_pic, captureFrame
...
def video_app(option_frame):
    ...
    btnFaceMesh = customtkinter.CTkButton(main_app_frame, image=img3, text="Boss Mode", width=200, height=200, command=lambda: face_detect_and_filter('BOSSMODE_FILTER'), compound='top')
    ...
    btnFaceMesh = customtkinter.CTkButton(main_app_frame, image=img4, text="Police", width=200, height=200, command=lambda: face_detect_and_filter('POLICE_FILTER'), compound='top')
    ...
    btnFaceMesh = customtkinter.CTkButton(main_app_frame, image=img5, text="Pirate", width=200, height=200, command=lambda: face_detect_and_filter('PIRATE_FILTER'), compound='top')
    ...
    btnFaceMesh = customtkinter.CTkButton(main_app_frame, image=img6, text="Face Swap (Experimental)", width=200, height=200, command=captureFrame, compound='top')
...
def image_app(option_frame):
    ...
    image_frame.grid_rowconfigure(1, weight=1)  # Add additional rows for balancing
    ...
    btnFaceMesh = customtkinter.CTkButton(image_frame, image=img1, text="Boss Mode", width=200, height=200, command=lambda: face_detect_and_filter('BOSSMODE_FILTER'), compound='top')
